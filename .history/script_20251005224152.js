...
// Enhanced smooth FAQ animations: intercept clicks in capture phase and animate height
(function enhanceFaqAccordion() {
  const items = Array.from(document.querySelectorAll("#faq .faq-new details"));
...
(function initI18n() {
  const i18n = {
    ru: {
      ...
      "#services .pricing-grid > article:nth-of-type(1) .desc":
        "Идеально подходит для малого бизнеса, лендинг или портфолио.",
  ...
  try {
    ...
    i18n.et[".contact-widgets .tick-list li:nth-of-type(3)"] =
      "30-p\u00E4evane tugi p\u00E4rast k\u00E4ivitust";
